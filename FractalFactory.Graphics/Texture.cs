...
{
    public class InvalidTexture : Texture
    {
        public InvalidTexture() : base() { }
    }
    ...
    public class Texture
    {
        ...
        public int Rows { get { return ((image == null) ? 0 : image.Height); } }
        public int Cols { get { return ((image == null) ? 0 : image.Width); } }
        public int Size { get { return ((image == null) ? 0 : Rows * Cols * 4); } }
        public int Orientation { get; set; } = 0;
        public byte[] Values { get { return ((image == null) ? null! : image.Data); } }

        protected Texture() { handle = -1; }
        ...
        public static Texture LoadFromMemory(byte[] data, int width, int height)
        {
            ...
            img.Comp = ColorComponents.RedGreenBlueAlpha;
            img.Data = data;
        ...
        public Texture(int glHandle, ImageResult img)
        {
            handle = glHandle;
            image = img;
        }
